function tex_hatch(obj, pattern, color, style, step, width)
	switch pattern
		case 'nwse'
		...
		case 'sqrt'
			...
			tex_hatch(obj, 'vert', color, style, step, width);
		otherwise
			'''nwse''|''swne''|''hrzt''|''vert''|''cross''|''sqrt'''
	end
end

function tex_actual_hatch(obj,angle,color,style,step,width)
